...
module.exports = function(sensors) {
  ...
  router.post('/display', function(req, res) {
    ...
    screencolor.red = (req.body['color.red'] == undefined ? 50 : parseInt(screencolor.red));
    screencolor.green = (req.body['color.green'] == undefined ? 50 : parseInt(screencolor.green));
    screencolor.blue = (req.body['color.blue'] == undefined ? 50 : parseInt(screencolor.blue));
    res.status(200).send();
  });
